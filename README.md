...
> [!IMPORTANT]
> ⚠️ **This repository is archived. It contains the legacy code of the old VedaWeb platform. Go to the repository of [Tekst](https://github.com/VedaWebProject/Tekst) for the new research platform software developed by the VedaWeb project!**

This is the code repository for the _VedaWeb_ platform, which has been developed as part of the [VedaWeb project](https://vedaweb.uni-koeln.de/).
